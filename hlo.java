...
abstract class Account {
    ...
    abstract double calculateInterest(double amount) throws Exception;
}
...
class FDaccount extends Account {
    ...
    double calculateInterest(double amount) throws Exception {
...
class RDaccount extends Account {
    ...
    double calculateInterest(double Ramount) throws Exception {
        ...
        if (RDamount < 0 || noOfMonths < 0 || age < 0) {
            throw new Exception("Invalid input.");
        }
    ...
    double calculateInterest(double amount) throws Exception {
        ...
        switch (accountChoice) {
            ...
            case 2:
                ...
                break;
            default:
                throw new Exception("Please choose the right account again");
        }
